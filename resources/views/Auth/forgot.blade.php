     ...
     <div class="container">
         <div class="row vh-100 justify-content-between align-items-center">
             <div class="col-12">
                 ...
                 <form action="{{route('forgot')}}" method="post" class="row row-eq-height lockscreen  mt-5 mb-5">
                     @csrf
                     ...
                     <div class="login-form col-12 col-sm-7">
                         ...
                         <div class="form-group mb-3">
                             ...
                             <input class="form-control" name="username" value="{{old('username')}}" type="text" id="username" required="" placeholder="کد ملی ">
                         </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-7" id="captchaRefresh" style="cursor: pointer">
                                         ...
                                         <img id="captcha" class="cap col-xs-5" src="{{route('captcha',['capForgot',CAPTCHA['forgot'][1],CAPTCHA['forgot'][2]]).'?i='.rand(1,1000)}}">
                                     </div>
                                 </div>
                             </div>
                         @endif
